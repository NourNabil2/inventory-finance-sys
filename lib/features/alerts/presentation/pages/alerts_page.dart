...
class AlertsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        // 🚨 ربطنا العنوان بالترجمة
        const PageHeader(titleKey: 'alerts.title'),
        Expanded(
              ...
              if (state is AlertsLoaded) {
                if (state.alerts.isEmpty) {
                  return EmptyStateWidget(
                    ...
                    // 🚨 ربطنا حالة الفراغ بالترجمة
                    title: 'alerts.empty_title'.tr(),
                    subtitle: 'alerts.empty_sub'.tr(),
                    isFullPage: false,
                  );
                }
...
class _AlertCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // 🚨 الذكاء الاصطناعي للكارت: تحديد الألوان والأيقونات بناءً على حالة الإشعار 🚨
        ...
        child: Container(
          ...
          child: ClipRRect(
            ...
            child: Container(
              decoration: BoxDecoration(
                border: Border(
                  right: BorderSide(color: statusColor, width: 4.w), // 👈 اللون يتغير هنا
                ),
              ),
              padding: EdgeInsets.all(16.w),
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: surfaceColor, // 👈 لون الخلفية للأيقونة
                      shape: BoxShape.circle,
                    ),
                    child: Icon(statusIcon, color: statusColor, size: 22.r), // 👈 الأيقونة تتغير هنا
                  ),
                  SizedBox(width: 14.w),
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 6.h),
                        // 🚨 إضافة عنوان جانبي يوضح هو متأخر ولا ميعاده بكرة
                        Text(
                          statusTitle,
                          style: TextStyle(
                            fontSize: 12.sp,
                        ...
                        SizedBox(height: 4.h),
                        // 🚨 ربط النصوص بالترجمة واستخدام daysDiff
                        RichText(
                          text: TextSpan(

...
class ItemModel extends ItemEntity {
  ...
  factory ItemModel.fromJson(Map<String, dynamic> json) {
    ...
    return ItemModel(
      ...
      priceFilm:    (json['price_film'] as num?)?.toDouble() ?? 0.0,
      priceSeries:  (json['price_series'] as num?)?.toDouble() ?? 0.0,
      priceAd:      (json['price_ad'] as num?)?.toDouble() ?? 0.0,
  ...
  factory ItemModel.fromEntity(ItemEntity e) => ItemModel(
    ...
    priceFilm:    e.priceFilm,
    priceSeries:  e.priceSeries,
    priceAd:      e.priceAd,
    totalQty:     e.totalQty,
